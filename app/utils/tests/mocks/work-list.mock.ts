export const mockWorkList = [
  ...
  },
  {
    ...
    sys: {
      ...
      id: "1u4Pas3pFZipRqJmt0fOwo",
      type: "Entry",
      createdAt: "2024-07-21T08:07:43.650Z",
      updatedAt: "2024-10-16T15:15:27.502Z",
      environment: {
        sys: {
          id: "master",
          type: "Link",
    ...
    fields: {
      name: "Capgemini",
      workTitle: "Intern Software Engineer",
      description: {
        data: {},
        content: [
          {
            ...
            content: [
              {
                ...
                marks: [],
                value:
                  "Working in an international project team, I focused on creating a proof-of-concept app in the mobile\nservice industry to acquire potential clients. I facilitated collaboration by establishing a\nmonorepository and used module federation for flexible technology stack development, leveraging\ncutting-edge technologies like the latest Next.js within an Nx monorepo. Additionally, I set up CI/CD\nprocesses and developed a self-hosted library on GitLab.",
                nodeType: "text",
              },
            ],
            nodeType: "paragraph",
